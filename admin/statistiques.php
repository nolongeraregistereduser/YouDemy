...
// New statistics
$totalClients = $user->getTotalClients();
        ...
        <div class="flex-1 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold mt-2"><?php echo implode($totalClients); ?></h3>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm">Nombre total de transactions</p>
                            <h3 class="text-2xl font-bold mt-2"><?php echo implode($totalTransactions); ?></h3>
                        </div>
                        <div class="bg-yellow-100 p-3 rounded-full">
                            <i data-lucide="repeat" class="w-6 h-6 text-yellow-600"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm">Montant moyen des transactions</p>
                            <h3 class="text-2xl font-bold mt-2"><?php echo number_format(implode($averageTransaction), 2); ?> €</h3>
                        </div>
